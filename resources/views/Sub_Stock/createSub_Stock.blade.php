...
<div class="row">
			...
			<form action="{{route('Sub_Stock.store')}}" method="post">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control " name="decription" id="decription" required maxlength="50">
				...
				<div class="form-group">
					...
					<input type="date" class="form-control" name="date" id="date" class="datepicker" data-date-format="mm/dd/yyyy" required maxlength="50">
